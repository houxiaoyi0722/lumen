...
public class CacheConfiguration extends CachingConfigurerSupport {
    ...
    @Bean
    public RedisCacheManager fuzzyDeleteRedisCacheManager(RedisConnectionFactory redisConnectionFactory) {
        ...
        return FuzzyDeleteRedisCacheManager
                .fuzzyBuilder(redisCacheWriter)
